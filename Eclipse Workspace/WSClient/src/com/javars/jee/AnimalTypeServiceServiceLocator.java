...
public class AnimalTypeServiceServiceLocator extends org.apache.axis.client.Service implements com.javars.jee.AnimalTypeServiceService {
    ...
    private java.lang.String AnimalTypeService_address = "http://localhost:8080/SoapWebservices/services/AnimalTypeService";
    ...
    public com.javars.jee.AnimalTypeService getAnimalTypeService() throws javax.xml.rpc.ServiceException {
    ...
    public com.javars.jee.AnimalTypeService getAnimalTypeService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.javars.jee.AnimalTypeServiceSoapBindingStub _stub = new com.javars.jee.AnimalTypeServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.javars.jee.AnimalTypeService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.javars.jee.AnimalTypeServiceSoapBindingStub _stub = new com.javars.jee.AnimalTypeServiceSoapBindingStub(new java.net.URL(AnimalTypeService_address), this);
                _stub.setPortName(getAnimalTypeServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://jee.javars.com", "AnimalTypeServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://jee.javars.com", "AnimalTypeService"));
        }
